...
class OpenSslAes {
	 ...
	 */
	static String encrypt(String password, String clearText) throws NoSuchAlgorithmException, NoSuchPaddingException,
	 ...
	 * @throws IllegalBlockSizeException
	 */
	static String decrypt(String password, String source) throws NoSuchAlgorithmException, NoSuchPaddingException,
			InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
		final byte[] pass = password.getBytes(US_ASCII);
